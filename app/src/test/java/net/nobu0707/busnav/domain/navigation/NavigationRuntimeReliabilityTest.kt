...
class NavigationRuntimeReliabilityTest {
    ...
    @Test fun headingUpAnchorUsesVisibleViewportAndSameFixForMarkerAndCamera() {
        ...
        assertEquals(0.72, (portrait.topPaddingPx + 800 - portrait.bottomPaddingPx) / 2 / 640, 0.001)
        val landscape = navigationMapFrame(fix, up, 0.0, 360, 80)
        assertEquals(0.72, (landscape.topPaddingPx + 360 - landscape.bottomPaddingPx) / 2 / 280, 0.001)

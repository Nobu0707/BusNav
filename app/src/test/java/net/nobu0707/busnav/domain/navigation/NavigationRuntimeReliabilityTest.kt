...
class NavigationRuntimeReliabilityTest {
    ...
    @Test fun headingUpAnchorUsesVisibleViewportAndSameFixForMarkerAndCamera() {
        ...
        assertEquals(640 - 33.9, (portrait.topPaddingPx + 800 - portrait.bottomPaddingPx) / 2, 0.001)
        val landscape = navigationMapFrame(fix, up, 0.0, 360, 80)
        assertEquals(280 - 33.9, (landscape.topPaddingPx + 360 - landscape.bottomPaddingPx) / 2, 0.001)
